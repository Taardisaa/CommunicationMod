        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                while (true) {
                    ...
                    if (nextChar == -1) {
                        throw new IOException("Socket stream closed by external process.");
                ...
                logger.error("Message could not be received from external process. Shutting down reading thread.");
